...
<<<<<<< HEAD
        ...
        <button class="btn btn-primary btn-sm btn-block" type="submit">{{ __('Login') }}</button>
        
            @if (Route::has('register'))
                <form action="">
                  <button class="btn btn-primary btn-sm btn-block" type="button"><a style="color: white!important;" href="{{ route('register') }}">Register</a></button>
                </form>
